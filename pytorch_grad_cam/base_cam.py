...
class BaseCAM:
    ...
    def set_camid_and_target_veiew(self,camid,target_view):
        self.camid = camid
        self.target_view = target_view

    def forward(self, input_img):
        return self.model(input_img,cam_label= self.camid,view_label= self.target_view)
    ...
    def forward(self, input_tensor, target_category=None, eigen_smooth=False):
        ...
        output = self.activations_and_grads(input_tensor, self.camid, self.target_view)
