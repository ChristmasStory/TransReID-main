...
Tips:  For person datasets  with size 256x128, TransReID with stride occupies 15GB GPU memory and TransReID occupies 7GB GPU memory. 
...
python train_cam.py --config_file configs/VeRi/vit_base.yml MODEL.DEVICE_ID "('3')" TEST.WEIGHT '../logs/veri_vit_base/transformer_120.pth'
